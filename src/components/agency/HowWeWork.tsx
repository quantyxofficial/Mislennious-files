    ...
    return (
        <section className="py-24 px-6 lg:px-24 relative z-10 bg-gradient-to-b from-white/40 to-transparent">
            <div className="max-w-[1400px] mx-auto">
                ...
                >
                    <span className="inline-block py-2 px-6 border border-white/10 rounded-full text-[10px] font-bold tracking-[0.3em] uppercase text-lux-muted bg-white/5 backdrop-blur-md mb-6">
                        Our Unique Model
                    </span>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="text-center bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-12"
                >
