...
export const ProblemOfTheDay: React.FC = () => {
    ...
    return (
        <div className="relative overflow-hidden bg-lux-glass border border-lux-glassBorder backdrop-blur-xl text-white rounded-3xl p-8 shadow-xl">
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center gap-4">
                    <Link
                        ...
                        className="flex-1 py-3 bg-white text-black rounded-full text-[10px] font-bold uppercase tracking-[0.2em] text-center hover:bg-lux-cream hover:text-white transition-colors shadow-lg"
                    >
                        Solve Now
                    </Link>
