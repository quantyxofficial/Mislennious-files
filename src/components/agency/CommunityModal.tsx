        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4 pointer-events-auto">
                    ...
                    >
                        {/* Glass Container */}
                        <div className="bg-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_30px_60px_-12px_rgba(0,0,0,0.5)] rounded-[2.5rem] p-1 overflow-hidden">

                            {/* Inner Content Area */}
                            <div className="relative bg-white/5 rounded-[2.25rem] p-8 md:p-10 flex flex-col items-center text-center overflow-hidden">
                                ...
                                <button
                                    onClick={onClose}
                                    className="absolute top-5 right-5 p-2 text-white/60 hover:text-white transition-colors rounded-full hover:bg-white/10 z-20"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                                ...
                                <motion.div
                                    ...
                                    className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-900/50 to-emerald-900/50 border border-emerald-500/20 flex items-center justify-center text-emerald-400 mb-6 shadow-sm"
                                >
                                ...
                                <div className="relative z-10 space-y-2 mb-8">
                                    <h3 className="font-serif text-3xl text-white tracking-tight">
                                        Join the <span className="italic text-emerald-400/90">Community</span>
                                    </h3>
                                ...
                                <motion.div
                                    ...
                                    className="relative group bg-white/5 p-3 rounded-2xl border border-white/10 shadow-sm mb-8 hover:bg-white/10 transition-all duration-300"
                                >
