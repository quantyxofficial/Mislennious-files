...
export const ClientMarquee: React.FC = () => {
  return (
    <section className="w-full relative z-20 py-8">
      ...
      <div className="max-w-[1400px] mx-auto bg-black/30 backdrop-blur-xl border border-white/40 rounded-full overflow-hidden shadow-sm">
        <div className="flex flex-col md:flex-row items-stretch">

          <div className="w-full md:w-64 bg-black/10 flex items-center justify-center md:justify-start px-8 py-4 md:py-0 border-b md:border-b-0 md:border-r border-white/20 z-10 relative">
