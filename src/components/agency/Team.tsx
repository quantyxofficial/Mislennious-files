                    ...
                    <div className="lg:col-span-7 relative min-h-[350px] md:min-h-[400px] lg:-mt-20 mt-8 lg:mt-0">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                className="w-full bg-black/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden will-change-transform"
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex justify-between items-start mb-8 md:mb-10">
                                        ...
                                        <div className="px-3 py-2 md:px-4 md:py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-semibold">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center gap-3 text-lux-muted/80 bg-white/5 p-4 rounded-xl inline-flex backdrop-blur-sm border border-white/10">
