  ...
  return (
    <section className="relative min-h-screen flex items-start md:items-center justify-center overflow-hidden px-6 md:px-0 pt-32 md:pt-20">
      ...
      <div className="relative z-10 max-w-[95vw] md:max-w-[90vw] text-center space-y-10 md:space-y-12 mt-4 md:mt-0 mx-auto">
        ...
        >
          <span className="inline-block py-2 px-6 border border-white/10 rounded-full text-[11px] md:text-[12px] font-bold tracking-[0.2em] md:tracking-[0.3em] uppercase text-lux-muted bg-white/5 backdrop-blur-md">
        ...
        >
          <button
            ...
            className="w-full md:w-auto px-10 py-4 bg-lux-text text-lux-cream font-semibold text-sm tracking-[0.2em] uppercase hover:bg-black hover:text-lux-text dark:hover:bg-white dark:hover:text-black transition-all rounded-full hover:-translate-y-1 md:mr-2"
            data-hover
          >
            Explore Collective
          </button>
