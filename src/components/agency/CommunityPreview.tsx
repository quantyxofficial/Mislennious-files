            ...
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-baseline gap-6 mb-12">
                    ...
                    >
                        <Link
                            to="/events"
                            className="group flex items-center gap-3 px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 text-lux-text rounded-full hover:bg-white hover:text-black transition-all duration-500 shadow-sm"
                            data-hover
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-5 auto-rows-[140px]">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="md:col-span-6 lg:col-span-7 row-span-3 bg-white/5 backdrop-blur-lg border border-white/10 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.5)] rounded-[2.5rem] p-10 flex flex-col justify-between group overflow-hidden"
                    >
                    ...
                    <motion.div
                        ...
                        className="md:col-span-3 lg:col-span-2 row-span-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center text-center shadow-sm group hover:bg-white/10 transition-colors duration-500"
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.3 }}
                        className="md:col-span-3 lg:col-span-3 row-span-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center text-center shadow-sm group hover:bg-white/10 transition-colors duration-500"
                    >
