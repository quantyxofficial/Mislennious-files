...
import { MARQUEE_ITEMS } from '../../data/siteConstants';
...
export const VerticalMarquee: React.FC = () => {
  ...
  return (
    <motion.div 
      ...
      className="fixed left-6 top-1/2 -translate-y-1/2 h-[80vh] w-14 rounded-full border border-white/10 bg-black/40 backdrop-blur-xl z-40 hidden lg:flex flex-col items-center overflow-hidden shadow-2xl shadow-black/5"
    >
