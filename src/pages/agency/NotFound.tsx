        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-stone-50">
            ...
            <div className="relative z-10 px-6 max-w-2xl mx-auto text-center">
                ...
                >
                    <Link
                        to="/"
                        className="w-full sm:w-auto px-8 py-3 bg-lux-text text-lux-cream rounded-full text-sm font-semibold tracking-wider uppercase hover:bg-black hover:text-lux-text dark:hover:bg-white dark:hover:text-black transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
