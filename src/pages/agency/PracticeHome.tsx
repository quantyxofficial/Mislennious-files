...
export const PracticeHome: React.FC = () => {
    ...
    return (
        <HelmetProvider>
            ...
            <div className="min-h-screen pt-4 pb-12 px-6 md:px-12 relative overflow-hidden font-sans">
                <Helmet>
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {topics.map((topic, idx) => (
                                    <motion.div
                                        ...
                                        className="group bg-lux-glass backdrop-blur-md border border-lux-glassBorder rounded-[2.5rem] p-5 hover:bg-lux-stone hover:shadow-xl hover:shadow-white/5 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
                                    >
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-xl shadow-sm text-lux-text group-hover:scale-110 transition-transform duration-500">
                                                    {topic.icon}
                                                </div>
                                            ...
                                            <div className="flex flex-col gap-2.5 pt-4">
                                                <Link
                                                    ...
                                                    className="w-full h-10 flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest bg-lux-text text-lux-cream rounded-full hover:bg-black hover:text-lux-text transition-all shadow-md shadow-lux-text/10 hover:shadow-lux-text/20 hover:scale-[1.02] active:scale-95"
                                                >
                                                ...
                                                {topic.hasStudyMaterial ? (
                                                    <Link
                                                        to={`/study/${topic.id}`}
                                                        className="w-full h-10 flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-lux-text bg-white/5 border border-white/10 rounded-full hover:bg-white hover:text-black transition-all duration-300 group/btn"
                                                    >
