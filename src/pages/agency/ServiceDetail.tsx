                        ...
                        >
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4 shrink-0">
                                <button
                                    ...
                                    className="h-12 px-8 bg-lux-text text-lux-cream text-xs font-bold uppercase tracking-[0.15em] hover:bg-black hover:text-lux-text dark:hover:bg-white dark:hover:text-black transition-all flex items-center justify-center gap-2 group w-full sm:w-auto"
                                >
