...
export const StudyMaterials: React.FC = () => {
    ...
    return (
        <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 min-h-screen bg-black">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-16 text-center">
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                        <span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-[0.1em] border bg-white/5 text-white border-white/10">
                            Course Curriculum
                        </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {curriculum.chapters.map((chapter: any, index: number) => (
                        <Link
                            ...
                            className="group relative bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/[0.08] hover:border-white/20 transition-all duration-500 overflow-hidden"
                        >
                            <div className="absolute top-0 right-0 p-8 opacity-5 font-serif text-8xl text-white group-hover:scale-110 transition-transform duration-700 select-none pointer-events-none">
                                {index + 1}
                            </div>

                            <div className="relative z-10">
                                <span className="inline-block px-3 py-1 rounded-full bg-white/5 text-lux-muted text-[10px] font-bold uppercase tracking-widest mb-6 group-hover:bg-white group-hover:text-black transition-colors duration-300">
                                ...
                                <p className="text-lux-muted text-sm leading-relaxed mb-8">{chapter.description}</p>
                ...
                <div className="mt-20 text-center">
                    <div className="inline-block p-1 rounded-full bg-white/5">
                        <div className="bg-white/5 backdrop-blur rounded-full px-8 py-10 md:px-12 border border-white/10">
                            ...
                            <Link
                                to={`/practice/${topic}`}
                                className="inline-flex items-center gap-2 px-8 py-4 bg-lux-text hover:bg-black hover:text-lux-text text-lux-cream font-bold uppercase tracking-[0.2em] text-[11px] rounded-full transition-all duration-300 shadow-xl shadow-black/5 hover:-translate-y-1"
                            >
