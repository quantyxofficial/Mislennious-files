...
export const Events: React.FC = () => {
    ...
    useEffect(() => {
        updateMetaTags(SEO_CONFIG.events);
    }, []);
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    >
                        <button
                            ...
                            className="group flex items-center gap-3 px-8 py-4 bg-lux-text text-lux-cream font-semibold text-xs tracking-[0.15em] uppercase hover:bg-black hover:text-lux-text dark:hover:bg-white dark:hover:text-black transition-all rounded-full"
                        >
                ...
                <div className="lg:col-span-7 space-y-6">
                    ...
                    >
                        <div className="relative aspect-[1200/400] md:aspect-[3/1] overflow-hidden">
                            {/* Logo Overlay */}
                            <div className="absolute top-6 left-6 z-20 bg-white/10 backdrop-blur-md border border-white/20 p-2.5 rounded-2xl shadow-2xl">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 bg-black/20 backdrop-blur-[2px]">
                                <button
                                    ...
                                    className="bg-white text-black px-10 py-4 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] shadow-2xl hover:bg-lux-cream hover:text-white transition-all transform hover:scale-110 active:scale-95 flex items-center gap-2"
                                >
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full border text-[10px] font-bold uppercase tracking-wider transition-all
                                                ${event.status === 'Pipeline'
                                                    ...
                                                    : 'border-lux-text bg-lux-text text-lux-cream hover:bg-black hover:text-lux-text'}`}
                                        >
