                ...
                {isGraphicDesign ? (
                    <>
                        ...
                        <div className="absolute top-[27.5%] left-[10%] text-left w-[450px]">
                            <h2 className="text-xl font-serif font-medium text-black tracking-wide uppercase whitespace-nowrap overflow-visible">
                                {name}
                            </h2>
                        </div>
                        ...
                        <div className="absolute top-[41%] left-[10%] text-left w-[400px]">
                            <p className="text-lg font-serif font-medium text-black tracking-wide uppercase whitespace-nowrap overflow-visible">
                                {name},
                            </p>
                        </div>
                    </>
                    ...
                    <>
                        ...
                        <div className="absolute top-[27.5%] left-[36%] text-left w-[400px]">
                            <p className="text-md font-serif font-medium text-black whitespace-nowrap overflow-visible">
                        ...
                        <div className="absolute top-[46.5%] left-[50%] transform -translate-x-1/2 text-left w-[300px]">
                            <p className="text-md font-serif font-medium text-black tracking-wide text-center w-full whitespace-nowrap">
                                {position || 'Core Team Member'}
                            </p>
                        </div>
                    </>
                    ...
                    <>
                        ...
                        <div className="absolute top-[20px] right-[20px] flex flex-col items-end gap-1">
                            <div className="text-right mb-1">
                                <h2 className="text-[8px] font-serif font-medium text-black tracking-widest uppercase whitespace-nowrap">
                                    {name}
                                </h2>
                                <p className="text-[6px] font-serif text-black/70 whitespace-nowrap">
                                    {email}
                                </p>
                            </div>
                        ...
                        <div className="absolute top-[42%] left-[50%] transform -translate-x-1/2 text-center w-full">
                            <h2 className="text-xl md:text-2xl font-serif font-medium text-black tracking-widest uppercase whitespace-nowrap">
                                {name}
                            </h2>
                        </div>
                    </>
                    ...
                    <>
                        ...
                        <div className="absolute top-[41.2%] left-[13%] text-left w-[400px]">
                            <h2 className="text-sm font-serif font-medium text-black tracking-wide uppercase whitespace-nowrap overflow-visible">
                                {name},
                            </h2>
                        </div>
                    </>
