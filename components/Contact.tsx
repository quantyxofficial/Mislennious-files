                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <a href="mailto:hello@kaizenstat.com" className="text-stone-300 hover:text-white transition-colors text-base" data-hover>hello@kaizenstat.com</a>
                            </li>
                            <li className="flex items-start gap-3">
                                <Phone className="w-4 h-4 text-stone-300 mt-1 flex-shrink-0" />
                                <a href="tel:+919876543210" className="text-stone-300 hover:text-white transition-colors text-base" data-hover>+91 98765 43210</a>
                            </li>
                            <li className="flex items-start gap-3">
